    ...
    <div className="product-search-page">
        <aside>
            ...
            <div>
                ...
                <input  min="100" max="1000000" type="range" value={maxPrice} onChange={(e)=>setMaxPrice(Number(e.target.value))}/>
            ...
            productLoading ? <Skeleton/> :(
                <div className="search-product-list">
                {
                 searchedData?.products.map((i)=>(
                     <ProductCard key ={i._id} productId={i._id} name={i.name} stock={i.stock} price={i.price} handler={addToCartHandler} photo={i.photo}/>
                 ))
                }
 </div>
